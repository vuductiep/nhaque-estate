export default function About() {
  return (
    <div className={'py-20 px-4 max-w-4xl mx-auto'}>
      <h1 className={'text-3xl font-bold mb-4 text-slate-800'}>About Nhaque Estate</h1>
      <p className={'mb-4 text-slate-700'}>
        Nhaque Estate is a leading real estate agency that specialized in helping clients buy, sale, and rent
